...
class SyncService:
    ...
    async def _get_sync_metadata(
        ...
        result = await self.db.execute(select(SyncMetadata))
    ...
    async def _upsert_event(
        ...
        if event:
            ...
            event.status_changed_at = datetime.fromisoformat(event_data["changed_at"])
            ...
            event = Event(
                ...
                status_changed_at=datetime.fromisoformat(event_data["changed_at"]),
            )
